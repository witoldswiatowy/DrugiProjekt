...
/*
Zrobić to samo co w pierwszym programie, ale zrobić to inaczej. Pętle walki z continue, a nie z tyloma if bo bedzie ładniej chyba

W Mainie zostawić tylko trzon a wszsytkie operacje dać do innych klas. Jak walke dać do classy która zbierać bedzie możliwości ataku i innych umiejętnośći jak unik.
 */
public class Main {
